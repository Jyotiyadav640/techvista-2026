...
const CONTACT_DATA = [
  { id: 1, section: 'coordinators', name: "Chinmay Chipkar", role: "Co-ordinator", email: "chinmay.chipkar1@vsit.edu.in", phone: "+91 93215 49088", img: "/SOCIAL/1.jpg" },
  { id: 2, section: 'coordinators', name: "Ananya Raut", role: "Co-ordinator", email: "ananya.raut1@vsit.edu.in", phone: "+91 88280 56870", img: "/SOCIAL/2.jpg" },
  { id: 3, section: 'event-heads', name: "Sushant Eppakayala", role: "Event Head", email: "sushant.eppakayala@vsit.edu.in", phone: "+91 96195 43525", img: "/event heads/sushant.jpg" },
  { id: 4, section: 'event-heads', name: "Antara Parab", role: "Event Head", email: "antara.parab@vsit.edu.in", phone: "+91 93245 72119", img: "/event heads/antara.jpg" },
  { id: 5, section: 'event-heads', name: "Harshita Velonde", role: "Event Head", email: "harshita.velonde@vsit.edu.in", phone: "+91 98673 36563", img: "/event heads/harshita.jpg" },
  { id: 6, section: 'event-heads', name: "Agnel", role: "Event Head", email: "agnel@vsit.edu.in", phone: "+91 91674 62287", img: "/event heads/agnel.jpg" },
  { id: 7, section: 'event-heads', name: "Vedant Desai", role: "Event Head", email: "vedant.desai@vsit.edu.in", phone: "+91 89766 82289", img: "/event heads/vedant.jpg" },
  { id: 8, section: 'event-heads', name: "Yaseen Shaikh", role: "Event Head", email: "yaseen.shaikh@vsit.edu.in", phone: "+91 85918 41899", img: "/event heads/yaseen.jpg" },
  { id: 9, section: 'event-heads', name: "Shivani Lokhande", role: "Event Head", email: "shivani.lokhande@vsit.edu.in", phone: "+91 99750 27077", img: "/event heads/shivani.jpg" },
  { id: 10, section: 'event-heads', name: "Kishan Bhul", role: "Event Head", email: "kishan.bhul@vsit.edu.in", phone: "+91 82913 24770", img: "/event heads/kishan.jpg" },
  { id: 11, section: 'event-heads', name: "Subham Sahu", role: "Event Head", email: "subham.sahu@vsit.edu.in", phone: "+91 91362 85734", img: "/event heads/subham.jpg" },
  { id: 12, section: 'event-heads', name: "Ayesha Khan", role: "Event Head", email: "ayeshakhatoon.khan@vsit.edu.in", phone: "+91 89285 85903", img: "/event heads/ayesha.jpg" },
  { id: 13, section: 'event-heads', name: "Pruthviraj Patil", role: "Event Head", email: "pruthviraj.patil@vsit.edu.in", phone: "+91 84528 21285", img: "/event heads/pruthvi.jpg" },
  { id: 14, section: 'committee-heads', name: "Anuj Gawde", role: "Contigent Leader", email: "anuj.gawde@vsit.edu.in", phone: "+91 96531 16701", img: "/SOCIAL/9.jpg" },
  { id: 15, section: 'committee-heads', name: "Parnavi Janbhor", role: "Assistant Contigent Leader", email: "parnavi.janbhor@vsit.edu.in", phone: "+91 74004 29237", img: "/SOCIAL/10.jpg" },
  { id: 16, section: 'committee-heads', name: "Chaitanya Kudalkar", role: "Digi Head", email: "chaitanya.kudalkar@vsit.edu.in", phone: "+91 93729 93446", img: "/SOCIAL/5.jpg" },
  { id: 17, section: 'committee-heads', name: "Aryan Sawant", role: "Digi Head", email: "aryan.sawant@vsit.edu.in", phone: "+91 83696 81887", img: "/SOCIAL/4.jpg" },
  { id: 18, section: 'committee-heads', name: "Jyoti Yadav", role: "Creative Head", email: "jyoti.yadav@vsit.edu.in", phone: "+91 87792 73885", img: "/SOCIAL/12.jpg" },
  { id: 19, section: 'committee-heads', name: "Aryaman Chilka", role: "Creative Head", email: "aryaman.chilka@vsit.edu.in", phone: "+91 91361 06309", img: "/SOCIAL/13.jpg" },
  { id: 20, section: 'committee-heads', name: "Mansi Kanojia", role: "Logistic Head", email: "mansi.kanojia@vsit.edu.in", phone: "+91 98202 62314", img: "/SOCIAL/15.jpg" },
  { id: 21, section: 'committee-heads', name: "Tanvi Karjekar", role: "Documentation Head", email: "tanvi.karjekar@vsit.edu.in", phone: "+91 98190 62662", img: "/SOCIAL/6.jpg" },
  { id: 22, section: 'committee-heads', name: "Divyashree Guda", role: "Social Media Head", email: "divyashree.gudla@vsit.edu.in", phone: "+91 93729 93446", img: "/SOCIAL/3.jpg" },
  { id: 23, section: 'committee-heads', name: "Anushka Salunkhe", role: "Graphics Head", email: "anushka.salunke@vsit.edu.in", phone: "+91 84250 53278", img: "/SOCIAL/14.jpg" },
            ...
            <div className="bg-black/60 backdrop-blur-2xl border border-white/20 p-1 md:p-1.5 rounded-full flex items-center shadow-2xl relative z-10 max-w-full overflow-x-auto no-scrollbar scroll-smooth">
              {['all', 'coordinators', 'event-heads', 'committee-heads'].map((type) => (
                <button
                  ...
                  className={`px-3 md:px-8 py-2 md:py-2.5 rounded-full font-orbitron text-[9px] md:text-xs font-bold uppercase tracking-tighter md:tracking-widest transition-all duration-500 whitespace-nowrap ${filter === type
