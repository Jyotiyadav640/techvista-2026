  ...
  [canScroll, maxState, scrollCooldown]
    ...
    useEffect(() => {
        ...
        const handleTouchEnd = (e) => {
            ...
            // Reduced Sensitivity: Increased threshold from 40 to 70
...
const HeroSection = () => (
    <div id="hero-text" className="w-full relative z-10 flex flex-col justify-center items-center h-full">
        <div className="fade-in-up delay-1">
            <p className="text-white text-base md:text-lg tracking-[0.3em] font-light text-center">VSIT PRESENTS</p>
        </div>
        <div className="w-full flex flex-col items-center my-8 md:my-12">
            <img src="/tech.png" alt="TechVista" className="w-auto h-24 md:h-48 lg:h-56 glitch fade-in-up delay-2 object-contain mx-auto" />
            <div className="flex flex-col items-center mt-4 fade-in-up delay-3">
                <p className="font-orbitron text-sm md:text-2xl text-white tracking-[0.2em]">27th - 28th FEBRUARY</p>
                <p className="font-orbitron text-lg md:text-3xl text-white tracking-[0.3em] font-bold mt-1">2 0 2 6</p>
            </div>
        </div>
        <div className="flex flex-col items-center gap-4">
            <p className="text-[#00ffd5] text-base md:text-xl tracking-widest font-light fade-in-up delay-6 italic font-serif text-center">A Simulated Paradigm</p>
            <div className="bg-black/40 border border-[#00ffd5]/30 backdrop-blur-md p-4 rounded-lg fade-in-up delay-7 max-w-lg">
                <p className="text-[#00ffd5] font-orbitron text-[10px] md:text-sm tracking-widest uppercase text-center">Registration Open for Competitions</p>
            </div>
        </div>
    </div>
);
    ...
    <div id="about-us-content" className="w-full px-4 md:px-0 flex flex-col items-center justify-center h-full">
        ...
        <div className="w-full max-w-3xl bg-black/20 backdrop-blur-lg rounded-lg border border-[#00ffd5]/20 p-6 md:p-8 description-box relative z-10">
            <p className="text-[10px] md:text-lg lg:text-xl text-gray-300 leading-relaxed font-light text-center">
                <strong>TechVista</strong> provides students with a unique opportunity to enhance their technical expertise, foster innovation, and develop teamwork skills within a simulated technical paradigm.
            </p>
        </div>
    </div>
);
...
const Home = () => { 
    ...
    const maxState = 2;
    const scrollCooldown = 1000; // Slightly increased cooldown for better stability
