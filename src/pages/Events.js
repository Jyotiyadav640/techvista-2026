...
const ALL_EVENTS = [
  { id: 1, type: 'technical', day: 2, time: "10:00 AM", title: "Data Viz Master", desc: "DataViz Master challenges participants to transform complex datasets into clear insights using Power BI, Excel.", img: "/Event Posters/Data-Viz Master/1770198539426~2.png", delay: "delay-1", registerPath: "seedBanker", date: "Saturday, 28 February 2026", location: "LAB: X-122" },
  { id: 2, type: 'technical', day: 1, time: "12:00 PM", title: "Web-O-War", desc: "Web-O-War challenges individuals to quiz, debug, and design themed websites, testing creativity, coding accuracy, and problem-solving.", img: "/Posters/ab.jpg", delay: "delay-2", registerPath: "ecoWeb", date: "Friday, 27 February 2026", location: "LAB: X-103" },
  ...
  { id: 5, type: 'technical', day: 1, time: "12:00 PM", title: "Code Crossword", desc: "Code Crossword is an individual event where participants solve programming clues by predicting outputs and identifying code types, testing logic, knowledge, and speed.", img: "/Event Posters/Code Crossword/code.png", delay: "delay-2", registerPath: "codeCrack", date: "Friday, 27 February 2026", location: "LAB: X-114" },
  { id: 6, type: 'technical', day: 1, time: "10:00 AM", title: "Bug Busters", desc: "In Bug Busters, participants race to debug broken HTML and JavaScript coding scripts. Fix all errors quickly to ensure your code matches the target output perfectly.", img: "/Event Posters/Debug Error/image_90839f54.png", delay: "delay-3", registerPath: "debugDevil", date: "Friday, 27 February 2026", location: "LAB:X-120 & X-121" },
  ...
  { id: 9, type: 'non-technical', day: 1, time: "09:30 AM", title: "Survival Strike: BGMI", desc: "Battle it out in the virtual world for the ultimate trophy.", img: "/poster.jpg", delay: "delay-3", registerPath: "gaming", date: "Friday, 27 February 2026", location: "Reading Room" },
            ...
            <div className="bg-black/60 backdrop-blur-2xl border border-white/20 p-1 md:p-1.5 rounded-full flex items-center shadow-2xl relative z-10 max-w-full overflow-x-auto no-scrollbar scroll-smooth">
              {['all', 'technical', 'non-technical', 'timeline'].map((filter) => (
                <button
                  ...
                  className={`px-4 md:px-8 py-2 md:py-2.5 rounded-full font-orbitron text-[9px] md:text-xs font-bold uppercase tracking-widest transition-all duration-500 whitespace-nowrap ${activeFilter === filter
              ...
              <div className="bg-black/60 backdrop-blur-2xl border border-white/20 p-1 md:p-1.5 rounded-full flex items-center shadow-2xl relative z-10">
                {[1, 2].map((day) => (
                  <button
                    ...
                    className={`px-6 md:px-10 py-2 md:py-2.5 rounded-full font-orbitron text-[9px] md:text-xs font-bold uppercase tracking-widest transition-all duration-500 whitespace-nowrap ${timelineDay === day
                  ...
                  <section className="w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-12 items-stretch justify-items-center">
                      {processedData.nonTechGrid.map(event => (
                        <div
                          key={event.id}
                          className={`w-full max-w-[320px] md:max-w-[380px] h-full transition-transform duration-500 hover:scale-[1.02] ${event.title.includes("Fusion-X") ? "md:col-span-2 justify-self-center" : ""
                            }`}
                        >
                          <EventCard {...event} onRegister={() => handleRegister(event.registerPath)} />
                        </div>
